...
Процедура ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты) Экспорт
	Объекты.Вставить("Справочник.ЕдиницыИзмерения", "");
	Объекты.Вставить("Справочник.Номенклатура", "");
	Объекты.Вставить("Справочник.СтатьиАналитики", "");
	Объекты.Вставить("Справочник.Счета", "");
КонецПроцедуры
