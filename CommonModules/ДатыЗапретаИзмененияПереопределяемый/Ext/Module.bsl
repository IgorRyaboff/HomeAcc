...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Имя = "Счет";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("7bd6c3c7-12c7-11ef-8534-a8a159483541");
	Раздел.Представление = НСтр("ru='Счет'");
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Счета"));
	
	Раздел = Разделы.Добавить();
	Раздел.Имя = "ДоходыРасходы";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("3472efec-12ce-11ef-8534-a8a159483541");
	Раздел.Представление = НСтр("ru='Данные о доходах и расходах'");
	
	Раздел = Разделы.Добавить();
	Раздел.Имя = "ЛишниеРасходы";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("3472efed-12ce-11ef-8534-a8a159483541");
	Раздел.Представление = НСтр("ru='Данные о лишних расходах'");
КонецПроцедуры
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ВводНачальныхОстатковНаСчетах.ПолноеИмя(), "Дата", "Счет", "Остатки.Счет");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.Доход.ПолноеИмя(), "Дата", "Счет", "Счет");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.Доход.ПолноеИмя(), "Дата", "ДоходыРасходы");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ОтменаРасхода.ПолноеИмя(), "Дата", "Счет", "Счет");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ОценкаЛишнихРасходов.ПолноеИмя(), "Месяц", "ЛишниеРасходы");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ПереводМеждуСчетами.ПолноеИмя(), "Дата", "Счет", "СчетСписания");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ПереводМеждуСчетами.ПолноеИмя(), "Дата", "Счет", "СчетЗачисления");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ПроизвольнаяОперацияПоСчетам.ПолноеИмя(), "Дата", "Счет", "СчетСписания");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ПроизвольнаяОперацияПоСчетам.ПолноеИмя(), "Дата", "Счет", "СчетЗачисления");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.Расход.ПолноеИмя(), "Дата", "Счет", "Счет");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.Расход.ПолноеИмя(), "Дата", "ДоходыРасходы");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.РегистрыНакопления.Доходы.ПолноеИмя(), "Период", "Счет", "Счет");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.РегистрыНакопления.Доходы.ПолноеИмя(), "Период", "ДоходыРасходы");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.РегистрыНакопления.ЛишниеРасходы.ПолноеИмя(), "Период", "ЛишниеРасходы");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.РегистрыНакопления.ОстаткиНаСчетах.ПолноеИмя(), "Период", "Счет", "Счет");
	
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.РегистрыНакопления.Расходы.ПолноеИмя(), "Период", "Счет", "Счет");
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.РегистрыНакопления.Расходы.ПолноеИмя(), "Период", "ДоходыРасходы");
КонецПроцедуры
