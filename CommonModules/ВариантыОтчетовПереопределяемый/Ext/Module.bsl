...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	Разделы.Добавить(Метаданные.Подсистемы.ДоходыРасходы, НСтр("ru='Отчеты по доходам и расходам'"));
	Разделы.Добавить(Метаданные.Подсистемы.Аналитики, НСтр("ru='Отчеты по аналитикам'"));
	Разделы.Добавить(Метаданные.Подсистемы.Долги, НСтр("ru='Отчеты по долгам'"));
КонецПроцедуры
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	Объекты.Добавить(Метаданные.Документы.ВводНачальныхОстатковНаСчетах);
	Объекты.Добавить(Метаданные.Документы.Доход);
	Объекты.Добавить(Метаданные.Документы.ОтменаРасхода);
	Объекты.Добавить(Метаданные.Документы.ОценкаЛишнихРасходов);
	Объекты.Добавить(Метаданные.Документы.ПереводМеждуСчетами);
	Объекты.Добавить(Метаданные.Документы.ПроизвольнаяОперацияПоСчетам);
	Объекты.Добавить(Метаданные.Документы.Расход);
КонецПроцедуры
