...
// Срабатывания SonarQube на описания процедур, заимствованные из модуля ОбновлениеИнформационнойБазыБСП
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "Константы.КатегорияРасходовДляНовыхСтатейРасходов.ПриНачальномЗаполнении";
